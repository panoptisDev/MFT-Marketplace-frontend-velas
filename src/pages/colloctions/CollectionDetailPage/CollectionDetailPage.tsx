...
const CollectionDetailPage = (props: any) => {
  ...
  function fetchCollection() {
    ...
    axios
      .get(`/collection/detail/${collectionName}`)
      .then((res) => {
        ...
        >
          <div className="container">
            <label className="banner-box">
              {collection && collection.banner_uri !== "" && (
                <img
            ...
            <div className="sub-box">
              ...
              <div className="user-info-box">
                <label className="avatar-box">
                  {collection && collection.logo_uri && (
                    <img
            ...
            <div className="detail-container">
              ...
              <div style={{ textAlign: "center" }} className="m-t-20">
