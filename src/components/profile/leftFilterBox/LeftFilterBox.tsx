...
const LeftFilterBox = (props: any) => {
  const [isShowEvents, setIsShowEvents] = useState(false);
  const [isShowActivityCollections, setIsShowActivityCollections] =
    useState(false);
  ...
  const options = [
    {
      value: "usd",
      label: "United Status Dollar (USD)",
      customAbbreviation: "",
    },
    ...
    <div className="leftFilterBox">
      {props.isMobile ? (
        <div className="filter-header">
          <p
            onClick={() => props.handleChangeFilterCondition([])}
            className="flex-1 header-label blue-label m-l-10"
          >
            Clear All
          </p>
          <p
            onClick={props.hideMenu}
            className="flex-1 header-label blue-label m-r-10"
          >
            Done
          </p>
        </div>
      ...
      {(props.tab === "activity" ||
        props.tab.includes("bids") ||
        props.tab.includes("listings")) && (
        <>
          <div
          ...
          >
            ...
            <div className="toggle-more">
              {isShowEvents ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            </div>
          </div>
          {isShowEvents && (
            <div className="filter-bar">
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("listings") ? " selected" : "")
                }
                onClick={() => handleClickButton("listings")}
              >
                Listings
              </div>
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("sales") ? " selected" : "")
                }
                onClick={() => handleClickButton("sales")}
              >
                Sales
              </div>
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("bids") ? " selected" : "")
                }
                onClick={() => handleClickButton("bids")}
              >
                Bids
              </div>
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("transfers") ? " selected" : "")
                }
                onClick={() => handleClickButton("transfers")}
              >
                Transfers
              </div>
            </div>
          ...
          <div
            className="filter-row"
            onClick={() =>
              setIsShowActivityCollections(!isShowActivityCollections)
            }
          >
          ...
          {isShowActivityCollections && (
            <>
              <div className="filter-bar">
                ...
                <div
                  className={
                    "filter-btn w-100-pro p-50" +
                    (filterConditions.includes("the meta kongz")
                      ? " selected"
                      : "")
                  }
                ...
                <div
                  ...
                  onClick={() =>
                    handleClickButton("Mutant Kongz & G.rilla Official")
                  }
                >
                  <div className="icon-30">
                ...
                <div
                  className={
                    "filter-btn w-100-pro p-50" +
                    (filterConditions.includes("Happier Town Official")
                      ? " selected"
                      : "")
                  }
                ...
                <div
                  className={
                    "filter-btn w-100-pro p-50" +
                    (filterConditions.includes("Celpi Official")
                      ? " selected"
                      : "")
                  }
      ...
      {!(
        ...
        <>
          ...
          >
            ...
            <div className="toggle-more">
              {isShowStatus ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            </div>
          </div>
          {isShowStatus && (
            <div className="filter-bar">
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("buy_now") ? " selected" : "")
                }
                onClick={() => handleClickButton("buy_now")}
              >
                Buy Now
              </div>
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("on_auction") ? " selected" : "")
                }
                onClick={() => handleClickButton("on_auction")}
              >
                On Auction
              </div>
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("new") ? " selected" : "")
                }
              ...
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("has_offer") ? " selected" : "")
                }
                onClick={() => handleClickButton("has_offer")}
              >
                Has Offers
              </div>
            </div>
          ...
          >
            ...
            <div className="toggle-more">
              {isShowPrice ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            </div>
          </div>
          {isShowPrice && (
            <div className="filter-bar">
              ...
              <div
                className={
                  "filter-btn" +
                  (filterConditions.includes("price") ? " selected" : "")
                }
                onClick={() => handleClickButton("price")}
              >
                Apply
              </div>
            </div>
          ...
          <div
            className="filter-row"
            onClick={() => setIsShowCollections(!isShowCollections)}
          >
            <p className="filter-header-label">Collections</p>
            <div className="toggle-more">
              {isShowCollections ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            </div>
          </div>
          {isShowCollections && (
            <div className="filter-bar">
      ...
      >
        ...
        <div className="toggle-more">
          {isShowChains ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
        </div>
      </div>
      {isShowChains && (
        <div className="filter-bar">
          <div
            className={
              "filter-btn p-0 tl" +
              (filterConditions.includes("ether") ? " selected" : "")
            }
          ...
          <div
            className={
              "filter-btn p-0 tl" +
              (filterConditions.includes("polygon") ? " selected" : "")
            }
          ...
          <div
            className={
              "filter-btn p-0 tl" +
              (filterConditions.includes("klaytn") ? " selected" : "")
            }
          ...
          <div
            className={
              "filter-btn p-50 tl" +
              (filterConditions.includes("solana") ? " selected" : "")
            }
      ...
      {!(
        ...
        <>
          ...
          >
            ...
            <div className="toggle-more">
              {isShowCategories ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            </div>
          </div>
          {isShowCategories && (
            <div className="filter-bar">
              <div
                className={
                  "filter-btn w-100-pro p-0 tl" +
                  (categoryCondition === "art" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "art"
                    ? setCategoryCondition("")
                    : setCategoryCondition("art");
                }}
              >
                <div className="icon-30">
              ...
              <div
                className={
                  "filter-btn w-100-pro p-0 tl" +
                  (categoryCondition === "collectibles" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "collectibles"
                    ? setCategoryCondition("")
                    : setCategoryCondition("collectibles");
                }}
              >
                <div className="icon-30">
              ...
              <div
                className={
                  "filter-btn w-100-pro p-0 tl" +
                  (categoryCondition === "domains" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "domains"
                    ? setCategoryCondition("")
                    : setCategoryCondition("domains");
                }}
              >
                <div className="icon-30">
              ...
              <div
                className={
                  "filter-btn w-100-pro p-50 tl" +
                  (categoryCondition === "music" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "music"
                    ? setCategoryCondition("")
                    : setCategoryCondition("music");
                }}
              >
                <div className="icon-30">
              ...
              <div
                className={
                  "filter-btn w-100-pro p-50 tl" +
                  (categoryCondition === "photo" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "photo"
                    ? setCategoryCondition("")
                    : setCategoryCondition("photo");
                }}
              >
                <div className="icon-30">
                  <img
                    src="/assets/img/parts/photography-category-dark.svg"
                    alt=""
                  />
                </div>
                Photography
              ...
              <div
                className={
                  "filter-btn w-100-pro p-50 tl" +
                  (categoryCondition === "sport" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "sport"
                    ? setCategoryCondition("")
                    : setCategoryCondition("sport");
                }}
              >
                <div className="icon-30">
              ...
              <div
                className={
                  "filter-btn w-100-pro p-50 tl" +
                  (categoryCondition === "tradings" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "tradings"
                    ? setCategoryCondition("")
                    : setCategoryCondition("tradings");
                }}
              >
                <div className="icon-30">
              ...
              <div
                className={
                  "filter-btn w-100-pro p-50 tl" +
                  (categoryCondition === "utility" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "utility"
                    ? setCategoryCondition("")
                    : setCategoryCondition("utility");
                }}
              >
                <div className="icon-30">
              ...
              <div
                className={
                  "filter-btn w-100-pro p-50 tl" +
                  (categoryCondition === "v_world" ? " selected" : "")
                }
                onClick={() => {
                  categoryCondition === "v_world"
                    ? setCategoryCondition("")
                    : setCategoryCondition("v_world");
                }}
              >
                <div className="icon-30">
          ...
          <div
            className="filter-row"
            onClick={() => setIsShowSale(!isShowSale)}
          >
            <p className="filter-header-label">On Sale In</p>
            <div className="toggle-more">
              {isShowSale ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            </div>
          </div>
          {isShowSale && (
            <div className="filter-bar">
              <input
                className="bordered-input w-100-pro flex-1"
                placeholder="Search"
              />
