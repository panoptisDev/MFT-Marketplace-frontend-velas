		...
		<div>
			{
				...
				<img src="/assets/img/parts/ether.png" alt="ether" width="40px" height="40px" style={{borderRadius: "50%"}} /> :
				<img src="/assets/img/parts/solana.svg" alt="solana" width="40px" height="40px" style={{borderRadius: "50%"}} />)
			}
		</div>
