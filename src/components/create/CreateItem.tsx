  ...
  function fetchCollections() {
    axios
      ...
      .then((res) => {
        ...
        res.data.collections.forEach((item: any, i: any) => {
          if (item.isPublic) {
  ...
  return (
    <div className="craeteItemContainer">
      <div className="upload-container">
        ...
        <p>
          Botsail will include a link to this URL on this item's detail page, so
        ...
        <p>
          ...
          its image.
          <span className="text-blue">Markdown</span> syntax is supported.
        </p>
        <textarea
          className="bordered-input height-3x"
          rows={3}
        ...
        <div className="modal-box m-t-15">
          <div className="box-header">
            ...
            <div
              ...
              onClick={() => setIsShowProModal(true)}
            >
              <AddSharp />
            </div>
            <PropertyModal
              target="property"
              isShow={isShowProModal}
        ...
        <div className="modal-box">
          <div className="box-header">
            ...
            <div
              className="round-border"
              onClick={() => setIsShowLvlModal(true)}
            >
              <AddSharp />
            </div>
            <PropertyModal
              target="level"
              isShow={isShowLvlModal}
              handleClose={(data: any) => {
            ...
            {lvlData.map((item: any, key) => (
              <div className="lvl-item" key={key}>
                ...
                <div className="lvl-item-bar">
                  <div
                    className="lvl-item-content"
                    style={{ width: (100 * item.value) / item.total + "%" }}
                  />
                </div>
              </div>
            ))}
        ...
        <div className="modal-box">
          <div className="box-header">
            ...
            <div
              className="round-border"
              onClick={() => setIsShowStatsModal(true)}
            >
              <AddSharp />
            </div>
            <PropertyModal
          ...
          {isUnlockable && (
            <>
              <textarea
                ...
                onChange={(event) => setLockContent(event.target.value)}
              />
              <p>
                <span className="text-blue">Markdown</span> syntax is supported.
              </p>
