...
export default function PropertyModal(
	...
	const defaultData =
		...
		: (target === "level" ? {name: "", total: 5, value: 3}
	...
	return (
		...
		>
			...
			>
				...
				<h3 className="modalTitle" style={{fontWeight: "bold", textAlign: "center"}}>Add {
			...
			>
				...
				<div className="properties-list">
					...
					<Button onClick={addItem} className="add-btn" ><p>Add more</p></Button>
				</div>
			</DialogContent>
			<DialogActions className="displayCenter">
				<Button className="save-btn" onClick={handleSubmit}><p>Save</p></Button>
			</DialogActions>
		</Dialog>
	);
}
