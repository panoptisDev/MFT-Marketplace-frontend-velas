	...
	return (
		<div className="settingContainer">
			<div className="header">
				...
				<Button className="outLineBtn"><strong>View my offers</strong></Button>
			</div>
			...
			<div className="noOffers">
				<img width={110} height={126} loading={'lazy'}  src={'/assets/img/account/offer-settings-illustration.svg'} alt = ''/>
