...
const Profile = (props: any) => {
  ...
  const siteHandle = (e: any) => {
    setSite(e.target.value);
  };
  const instagramHandle = (e: any) => {
    setInstagram(e.target.value);
  };
  const twitterHandle = (e: any) => {
          ...
          <div className="inputGroup">
            <div className="change-profile-banner">
              <div className="formControl">
                <h4 style={{ textAlign: "left" }}>Profile image</h4>
                <label className="avatarImgInput" htmlFor="avatarInput">
                  ...
                  />
                  <Button
                    className="explore image-banner-upload"
                    label="upload"
                  />
                  {avatar_url === "" || !avatar ? (
              ...
              <div className="formControl">
                <h4 style={{ textAlign: "left" }}>Profile Banner</h4>
                <div className="BannerImgInput">
                  ...
                  {banner && (
                    <span className={"removeImg"} onClick={removeBanner}>
                      &times;
                    </span>
                  )}
                </div>
